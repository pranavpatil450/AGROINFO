...
<html lang="en" class=" -webkit-">
   <head>
      ...
      <h1>
         The Weather report allows user to search a location of their choice and displays temperature details,crops that re favorable for the condition -->
      </h1>
      <style>
...
<?php if(($result['main']['temp']-273.15) < "11")
{
   echo'<img src="./crops1.jpeg" alt="My image" width="500px" height="500px"  style="vertical-align:middle;margin:40px 12.5px" />';
}
elseif( ($result['main']['temp']-273.15) < "21")
{
   echo '<img src="./crops2.jpeg" alt="My image" width="500px" height="500px"  style="vertical-align:middle;margin:40px 12.5px" />';
}
elseif( ($result['main']['temp']-273.15) < "31")
{
   echo'<img src="./crops3.jpeg" alt="My image" width="500px" height="500px"  style="vertical-align:middle;margin:40px 12.5px" />';
}
else
{
   echo'<img src="./crosp4.jpeg" alt="My image" width="500px" height="500px"  style="vertical-align:middle;margin:40px 12.5px" />';
}
?>
      </div>
