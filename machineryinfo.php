...
body h1{
    ...
    <body>
        ...
        <body>
            ...
            <div class="box">
                           <h1>AGRICUTURAL MACHINERY</h1>
            <br>
            <h2><span>1]</span> Tractor:-</h2>
            ...
            <div class="anch"><a href="./tractor.html">Click here for more Information</a></div>
        <br>
        </div>
        <div class="box">
        <h2><span>2]</span> Harvester:-</h2>
        <p>
        ...
        <div class="anch"><a href="./harvester.html">Click here for more Information</a></div>
        <br>
        </div>
        <div class="box">
        <h2><span>3]</span>Planter:-</h2>
        <p>
        ...
        <div class="anch"><a href="./planter.html">Click here for more Information</a></div>
        <br>
        </div>
        <div class="box">
        <h2><span>4]</span>Sprayers:-</h2>
        <p>
