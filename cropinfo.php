...
body h1{
    ...
    <body>
        ...
        <body>
            ...
            <h1>CROPS</h1>
            <br>
            <h2><span>1]</span> Wheat:-</h2>
            <p>Wheat is a grass widely cultivated for its seed, a cereal grain that is a worldwide staple food.The many species of wheat together make up the genus Triticum ; the most widely grown is common wheat . The archaeological record suggests that wheat was first cultivated in the regions of the Fertile Crescent around 9600 BCE. Botanically, the wheat kernel is a type of fruit called a caryopsis.</p>
        <div class="anch"><a href="./wheat.html">Click here for more Information</a></div>
        <br>
    </div>
    <div class="box">
        <h2><span>2]</span> CORN(MAIZE):-</h2>
        <p>Maize (MAYZ; Zea mays subsp. mays, from Spanish: maíz after Taino: mahis), also known as corn in North American and Australian English, is a cereal grain first domesticated by indigenous peoples in southern Mexico about 10,000 years ago.The leafy stalk of the plant produces pollen inflorescences (or "tassels") and separate ovuliferous inflorescences called ears that when fertilized yield kernels or seeds, which are fruits.The term maize is preferred in formal, scientific, and international usage as the common name because this refers specifically to this one grain whereas corn refers to any principal cereal crop cultivated in a country. For example, in North America and Australia corn is often used for maize, but in England and Wales it can refer to wheat or barley, and in Scotland and Ireland to oats.</p>
        <div class="anch"><a href="./corn.html">Click here for more Information</a></div>
        <br>
    </div>
    <div class="box">
        <h2><span>3]</span>SOYBEAN:-</h2>
        <p>The soybean, soy bean, or soya bean (Glycine max)is a species of legume native to East Asia, widely grown for its edible bean, which has numerous uses.
